...
public class Exam0215 extends com.eomcs.oop.ex08.b.sub.Y {
  ...
  // 다른 패키지의 객체를 파라미터로 받는 경우
  static void m2(com.eomcs.oop.ex08.b.sub.Y obj) {
    // obj.privateVar = 100;    접근 불가
    // obj.defaultVar = 100;
    // obj.protectedVar = 100; // 접근불가! Exam0215가 상속받아 만든 변수가 아니다.
    obj.publicVar = 100;
  }
  ...
  static void m3(com.eomcs.oop.ex08.b.Exam0215 obj) {
    ...
    // 상속받은 변수인 경우 상속 받은 클래스를 기준으로 접근 가능 여부를 따져야 한다.

    //    obj.privateVar = 100;
    //    obj.defaultVar = 100;
    obj.protectedVar = 100; // Y클래스 설계도에 따라 만든 변수이지만, 상속 받아 만든 변수이다.
    // super클래스의 변수는 접근 가능!!
