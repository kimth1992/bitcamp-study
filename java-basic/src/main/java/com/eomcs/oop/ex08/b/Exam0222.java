...
public class Exam0222 {
  ...
  public static void main(String[] args) {
    ...
    // 자동차 공장 객체를 먼저 만든다.
    //CarFactory factory = new CarFactory(); // 컴파일 오류!! 왜? 생성자가 private이라서!

    // 생성자가 private인 경우 보통 스태틱 메서드를 통해 인스턴스를 생성한다.
    ...
    // new 연산자를 이용하지 않고 스태틱 메서드를 호출해서 인스터스를 생성하는 경우
    // 다음 둘 중 하나이다.

    // 1) 인스턴스 생성 과정이 복접한 경우(Exam 0221)
    // 2) 인스턴스를 1개만 생성해야 하는 경우(Exam 0222)
    //
